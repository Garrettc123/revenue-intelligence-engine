...
def test_roi_calculates_from_gross_profit_not_revenue():
    result = ROICalculator.calculate(ROICalculationInput(10000, 1000, 0.3, attribution_tier=2, source_references=("hubspot:deal:1",), limitations=("Historical comparison only.",)))
